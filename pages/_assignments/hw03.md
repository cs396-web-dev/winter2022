...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                The current user's profile. Please use the User data model to get this information.
                <ul>
...
### 3. Implement POST, PATCH, and DELETE routes (16 points)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>DELETE /api/following/&lt;int:id&gt;/likes/&lt;int:id&gt;</td>
            <td>
...
* 16 points for POST / PATCH / DELETE requests
