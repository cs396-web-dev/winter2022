    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li><a href="https://photo-app-demo.herokuapp.com/api/bookmarks/1">/api/bookmarks/1</a></li>
                </ul>
            </td>
            <td></td>
            <td>List of Post object</td>
            <td>2</td>
        </tr>
    </tbody>
</table>
...
### 3. Publish your REST API (4 Points)
...
{:.compact}
* 14 points for GET requests
* 12 points for POST / PATCH / DELETE requests
* 4 points for deploying to Heroku
