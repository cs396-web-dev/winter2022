...
Reflective question fro HW3: the politics of the feed.
...
1. On your terminal or command line, navigate to your photo-app files from HW2.
...
### 2. [TODO] Integrate the HW3 files into your photo-app
Download hw03.zip and unzip it. You should see a directory structure that looks like this:

```shell

```

1. Copy the `models`, `views` and `tests` folders from `hw03` into `photo-app`
1. Edit the `.env` file. <a href="https://itnext.io/start-using-env-for-your-flask-project-and-stop-using-environment-variables-for-development-247dc12468be" target="_blank">Organizing environment variables</a> using the `.env` file.
...
Add DB connection environment variable to your `.env` file. Here is Sarah's `.env` file (your postgres password will be different):
...
* The user can only edit and delete comments, posts, and stories that they creted themselves.
...
### 2. Implement the following GET routes (14 Points)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                The post associated with the id. Already done for you.
                <ul>
        ...
        <tr>
            <td>GET /api/posts/&lt;int:post_id&gt;/comments</td>
            <td>
                The comments associated with a post
                <ul>
                    <li><a href="https://photo-app-demo.herokuapp.com/api/posts/1/comments">/api/posts/1/comments</a></li>
                </ul>
            </td>
            <td></td>
            <td>List of Comment objects</td>
            <td>2</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                List of suggested users to follow. For now, just display any 7 users that the current user isn't already following
                <ul>
        ...
        <tr>
            ...
            <td>
                List of stories of users you're following as well as your own story (if you have one).
                <ul>
...
### 3. Implement POST, PATCH, and DELETE routes (12 points)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                Should create a new post. Done for you.
                <ul>
                    <li><a href="https://photo-app-demo.herokuapp.com/api/posts">/api/posts</a></li>
                </ul>
            </td>
        ...
        <tr>
            ...
            <td>
                Should update the post. Done for you.
                <ul>
                    <li><a href="https://photo-app-demo.herokuapp.com/api/posts/3">/api/posts/3</a></li>
                </ul>
            </td>
            <td>
                <ul>
        ...
        <tr>
            ...
            <td>
                Should delete the post. Done for you.
                <ul>
                    <li><a href="https://photo-app-demo.herokuapp.com/api/posts/3">/api/posts/3</a></li>
                </ul>
        ...
        <tr>
            <td>POST /api/posts/&lt;int:post_id&gt;/comments</td>
            <td>
        ...
        <tr>
            <td>PATCH /api/comments/&lt;int:id&gt;</td>
            <td>
                Should update the specified comment.
                <ul>
                    <li><a href="https://photo-app-demo.herokuapp.com/api/comments/1">/api/comments/1</a></li>
                </ul>
            </td>
            <td>
                <ul>
...
## 5. Publish your REST API (5 Points)
...
Copy that environment variable to your `.env` file and comment out the DB_URL environment variable pointing to your local database instance.  Then, on your command line from the root of your `photo-app` directory, run the populate.py command again:
