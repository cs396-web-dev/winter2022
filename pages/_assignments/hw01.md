...
Using HTML & CSS (no JavaScript yet), you are going to build the following interface:

### Desktop Version
<img class="frame" style="width:100%;" src="/winter2022/assets/images/hw01/hw01-desktop.gif"/>

There are four main sections:
#### 1. Nav Bar
A nav bar, which has the title of the app (or logo) on the left and a username and log out button on the right:

<img class="frame large" src="/winter2022/assets/images/hw01/navbar.png"/>

#### 2. Recommendations Panel
A recommendations panel, which gives suggestions of who to follow:

<img class="frame" style="width:35%;" src="/winter2022/assets/images/hw01/recommendations.png"/>
