...
* Make sure **font colors** have sufficient **contrast** with the background being used 
    * Hint: there is a tool that helps analyze contrast on the [course's accessibility resources](/winter2022/accessibility-reference)
* **Describe** how you would add a feature so users can **easily add alt-text** to their images 
