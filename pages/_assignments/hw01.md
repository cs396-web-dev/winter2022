...
Something having to do with Accessibility. Consult with Victoria

{:#github}
#### 7. GitHub (1 point)
When you're done, please commit all of your changes and push them to GitHub. Then, paste a link to your private repo into Canvas.

## Part 3: Review the Rubric
Please consult the rubric below to ensure you have met the requirements for this assignment. Each item preceeded with a checkmark indicates a requirement.
