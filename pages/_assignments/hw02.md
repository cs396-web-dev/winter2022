...
### Submission format
Please submit a zipped folder (<a href="https://canvas.northwestern.edu/courses/157233/assignments/1017433" target="_blank">on Canvas</a>) called `hw02.zip` that contains all of the files used to complete your project. Within the zip file:
